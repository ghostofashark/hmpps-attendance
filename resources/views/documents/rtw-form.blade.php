...
<div class="field"><span class="label">Name:</span><span class="value">{{ $absence->staff->first_name }} {{ $absence->staff->last_name }}</span></div>
...
<div class="field"><span class="label">Band:</span><span class="value">{{ $absence->staff->band }}</span></div>
...
<div class="field"><span class="label">Date returned:</span><span class="value">{{ $absence->end_date?->format('d F Y') ?? 'To be confirmed' }}</span></div>
<div class="field"><span class="label">Total days absent:</span><span class="value">{{ $absence->duration_days }}</span></div>
...
<div class="box"><p><strong>5.</strong> Does this absence trigger any attendance action? Bradford score: {{ $absence->staff->bradford_score }}<br><br><br></p></div>
